...
public class LayoutView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        headingPanel.setBackground(new java.awt.Color(204, 204, 255));
        ...
        navigatioPanel.setBackground(new java.awt.Color(153, 204, 255));

        itemButton.setBackground(new java.awt.Color(51, 204, 255));
        ...
        orderButton.setBackground(new java.awt.Color(51, 204, 255));
    ...
    private void itemButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemButtonActionPerformed
        ...
        bodyPanel.removeAll();
        ip.setSize(bodyPanel.getWidth(), bodyPanel.getHeight());
        bodyPanel.add(ip);
        ip.repaint();
        ip.revalidate();
